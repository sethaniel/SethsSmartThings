...
metadata {
	definition(name: "Z-Wave Door/Window Sensor reversed", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.contact", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
